...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, dany.inc.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, dany.inc.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, dany.inc.domain.User.class.getName());
            createCache(cm, dany.inc.domain.Authority.class.getName());
